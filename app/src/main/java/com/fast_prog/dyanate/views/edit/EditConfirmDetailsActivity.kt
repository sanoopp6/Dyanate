...
import com.fast_prog.dyanate.views.SenderLocationActivity
...
class EditConfirmDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_edit_confirm_details)
        ...
        toolbar.setNavigationOnClickListener {
            if (tripID != null && Integer.parseInt(tripID!!) > 0) {
                if (ConnectionDetector.isConnected(this@EditConfirmDetailsActivity)) {
                    goingBack = true
        ...
        val colorSpan = ForegroundColorSpan(
            ContextCompat.getColor(
                this@EditConfirmDetailsActivity,
        ...
        confirmTripButton.setOnClickListener {
            UtilityFunctions.showAlertOnActivity(this@EditConfirmDetailsActivity,
    ...
    private inner class AddTripMasterBackground : AsyncTask<Void, Void, JSONObject>() {
        ...
        override fun onPreExecute() {
            super.onPreExecute()
            UtilityFunctions.showProgressDialog(this@EditConfirmDetailsActivity)
        }
        ...
        override fun doInBackground(vararg param: Void): JSONObject? {
            ...
            params["trip_id"] = Ride.instance.tripId!!
            ...
            if (response != null) {
                try {
                    if (response.getBoolean("status")) {
                        ...
                        UtilityFunctions.showAlertOnActivity(this@EditConfirmDetailsActivity,
                            getString(R.string.TripUpdated),
...
//                            val intent =
//                                Intent(this@EditConfirmDetailsActivity, WaitDriverActivity::class.java)
...
//                            startActivity(intent)
    ...
    private fun cancelOrRetry() {
        val builder = AlertDialog.Builder(this@EditConfirmDetailsActivity)
        val inflater = this@EditConfirmDetailsActivity.getLayoutInflater()
...
//                            val intent =
//                                Intent(this@EditConfirmDetailsActivity, ShipmentDetActivity::class.java)
//                            startActivity(intent)
//                            finish()
                        }
                    }
