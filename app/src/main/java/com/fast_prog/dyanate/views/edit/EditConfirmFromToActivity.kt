...
class EditConfirmFromToActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_edit_confirm_from_to)
...
//        txt_distance.startAnimation(UtilityFunctions.blinkAnimation)
        ...
        btn_confirm_route.setOnClickListener {
            UtilityFunctions.showAlertOnActivity(this@EditConfirmFromToActivity,
                resources.getString(R.string.AreYouSure), resources.getString(R.string.Yes),
                resources.getString(R.string.No), true, false,
                {
                    if (ConnectionDetector.isConnected(this@EditConfirmFromToActivity)) {
        ...
        btn_show_details.setOnClickListener {
            startActivity(
                Intent(this@EditConfirmFromToActivity, EditConfirmDetailsActivity::class.java)
                ...
                MarkerOptions().position(start).icon(
                    BitmapDescriptorFactory.fromBitmap(
                        createDrawableFromView(
                            this@EditConfirmFromToActivity,
                            marker1
                        )
                    )
                )
...
//                txt_distance.text = Ride.instance.distanceStr
    ...
    private inner class AddTripMasterBackground : AsyncTask<Void, Void, JSONObject>() {
        ...
        override fun onPreExecute() {
            super.onPreExecute()
            UtilityFunctions.showProgressDialog(this@EditConfirmFromToActivity)
        }
...
//    }
    ...
    private fun cancelOrRetry() {
        val builder = AlertDialog.Builder(this@EditConfirmFromToActivity)
        val inflater = this@EditConfirmFromToActivity.getLayoutInflater()
