...
import kotlinx.android.synthetic.main.activity_edit_receiver_location.*
import org.json.JSONArray
import org.json.JSONException
import java.util.*

class EditReceiverLocationActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_edit_receiver_location)
        ...
        Ride.instance.dropOffLatitude = order.tripToLat
        Ride.instance.dropOffLongitude = order.tripToLng
...
//            startActivity(
//                Intent(
//                    this@EditReceiverLocationActivity,
...
//        }
        ...
        bookmark_location_image_view.setOnClickListener {
            if (placeItemSelectedKey.isNullOrEmpty()) {
                UtilityFunctions.showAlertOnActivity(this@EditReceiverLocationActivity,
                    ...
                    false,
                    {
                        ...
                        try {
                            val snappyDB =
                                DBFactory.open(this@EditReceiverLocationActivity, Constants.DYNA_DB)
...
//                        } else {
                startActivity(
                    Intent(
                        this@EditReceiverLocationActivity,
                        EditShipmentDetActivity::class.java
...
//                }, {})
        ...
        gpsTracker = GPSTracker(this@EditReceiverLocationActivity)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap!!.setOnCameraIdleListener {
            if (ConnectionDetector.isConnected(this@EditReceiverLocationActivity)) {
    ...
    private fun checkPlayServices(): Boolean {
        ...
        val resultCode = gApi.isGooglePlayServicesAvailable(this@EditReceiverLocationActivity)
        if (resultCode != ConnectionResult.SUCCESS) {
            if (gApi.isUserResolvableError(resultCode)) {
                gApi.getErrorDialog(this@EditReceiverLocationActivity, resultCode, 100).show()
            } else {
